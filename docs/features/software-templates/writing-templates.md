...
Your templates will make use of the basic features of Nunjucks, one of the most
important of which is the filtering of values. For a complete list of the filters
natively available from Nunjucks and their usage, refer to the
[Nunjucks documentation](https://mozilla.github.io/nunjucks/templating.html#builtin-filters).

To learn about using built-in and custom extensions to the Nunjucks templating
environment, see [Template Extensions](./template-extensions.md).
