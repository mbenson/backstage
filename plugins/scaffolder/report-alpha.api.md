...
export const scaffolderTranslationRef: TranslationRef<
  'scaffolder',
  {
    ...
    readonly 'templateExtensions.filters.notAvailable': 'There are no template filters defined.';
    ...
    readonly 'templateExtensions.globals.values.notAvailable': 'There are no global template values defined.';
    ...
    readonly 'templateExtensions.globals.functions.notAvailable': 'There are no global template functions defined.';
