...
export const scaffolderTranslationRef: TranslationRef<
  'scaffolder',
  {
    ...
    readonly 'templateFilters.content.builtIn.heading': 'Built-in';
    readonly 'templateFilters.content.builtIn.schema.input': 'Input';
    readonly 'templateFilters.content.builtIn.schema.output': 'Output';
    readonly 'templateFilters.content.builtIn.schema.arguments': 'Arguments';
    readonly 'templateFilters.content.builtIn.examples': 'Examples';
    readonly 'templateFilters.content.builtIn.emptyState.title': 'No information to display';
    readonly 'templateFilters.content.builtIn.emptyState.description': 'There are no built-in template filters available or there was an issue communicating with the backend.';
    readonly 'templateFilters.content.builtIn.metadataAbsent': 'Filter metadata unavailable';
    readonly 'templateFilters.content.additional.heading': 'Additional';
    readonly 'templateFilters.content.additional.schema.input': 'Input';
    readonly 'templateFilters.content.additional.schema.output': 'Output';
    readonly 'templateFilters.content.additional.schema.arguments': 'Arguments';
    readonly 'templateFilters.content.additional.examples': 'Examples';
    readonly 'templateFilters.content.additional.emptyState.title': 'No information to display';
    readonly 'templateFilters.content.additional.emptyState.description': 'There are no additional template filters available or there was an issue communicating with the backend.';
    readonly 'templateFilters.content.additional.metadataAbsent': 'Filter metadata unavailable';
    readonly 'templateFilters.title': 'Template filters';
    readonly 'templateFilters.subtitle': 'This is the collection of available template filters';
    readonly 'templateFilters.pageTitle': 'Template filters';
    readonly 'templateGlobals.content.value.heading': 'Values';
    readonly 'templateGlobals.content.value.emptyState.title': 'No information to display';
    readonly 'templateGlobals.content.value.emptyState.description': 'There are no global template values available or there was an issue communicating with the backend.';
    readonly 'templateGlobals.content.fn.heading': 'Functions';
    readonly 'templateGlobals.content.fn.schema.output': 'Output';
    readonly 'templateGlobals.content.fn.schema.arguments': 'Arguments';
    readonly 'templateGlobals.content.fn.examples': 'Examples';
    readonly 'templateGlobals.content.fn.emptyState.title': 'No information to display';
    readonly 'templateGlobals.content.fn.emptyState.description': 'There are no global template functions available or there was an issue communicating with the backend.';
    readonly 'templateGlobals.title': 'Template globals';
    readonly 'templateGlobals.subtitle': 'This is the collection of available template globals';
    readonly 'templateGlobals.pageTitle': 'Template globals';
