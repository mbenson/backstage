import{r as y,R as u}from"./index-CTjT7uj6.js";import{m as k}from"./makeStyles-Dm18XSEu.js";import{B as b}from"./Box-ByXAoPiX.js";import{T}from"./Tooltip-q1efGeM_.js";import{c as q,d as A}from"./ApiRef-BSBwTmJJ.js";import{g as c}from"./appWrappers-BdmV716_.js";import{s as w,D as g}from"./ref-8pKZtiZi.js";const j=q({id:"plugin.catalog.entity-presentation"});function E(e,n){const{kind:i,namespace:r,name:s,title:t,description:a,displayName:d,type:p}=x(e),l=w({kind:i||"unknown",namespace:r||g,name:s||"unknown"}),o=L({kind:i,namespace:r,name:s,context:n}),m=[d,t,o].find(f=>f&&typeof f=="string"),v=[m!==l?l:void 0,p,a].filter(f=>f&&typeof f=="string").join(" | ");return{entityRef:l,primaryTitle:m,secondaryTitle:v||void 0,Icon:void 0}}const h=e=>!!e&&typeof e=="string";function x(e){if(typeof e=="string"){let n=e.indexOf(":");const i=e.indexOf("/");i!==-1&&i<n&&(n=-1);const r=n===-1?void 0:e.slice(0,n),s=i===-1?void 0:e.slice(n+1,i),t=e.slice(Math.max(n+1,i+1));return{kind:r,namespace:s,name:t}}if(typeof e=="object"&&e!==null){const n=[c(e,"kind")].find(h),i=[c(e,"metadata.namespace"),c(e,"namespace")].find(h),r=[c(e,"metadata.name"),c(e,"name")].find(h),s=[c(e,"metadata.title")].find(h),t=[c(e,"metadata.description")].find(h),a=[c(e,"spec.profile.displayName")].find(h),d=[c(e,"spec.type")].find(h);return{kind:n,namespace:i,name:r,title:s,description:t,displayName:a,type:d}}return{}}function L(e){var d,p,l,o,m;const n=((d=e.kind)==null?void 0:d.toLocaleLowerCase("en-US"))||"unknown",i=e.namespace||g,r=e.name||"unknown",s=(l=(p=e.context)==null?void 0:p.defaultKind)==null?void 0:l.toLocaleLowerCase("en-US"),t=(m=(o=e.context)==null?void 0:o.defaultNamespace)==null?void 0:m.toLocaleLowerCase("en-US");let a=r;return(t&&i.toLocaleLowerCase("en-US")!==t||i!==g)&&(a=`${i}/${a}`),s&&n.toLocaleLowerCase("en-US")!==s&&(a=`${n}:${a}`),a}function N(e,n,i){const[r,s]=y.useState(e);return y.useEffect(()=>{s(e);const t=n==null?void 0:n.subscribe({next:a=>{s(a)},complete:()=>{t==null||t.unsubscribe()}});return()=>{t==null||t.unsubscribe()}},i),r}function I(e,n){const r=A().get(j),s=[r,JSON.stringify(e),JSON.stringify(n||null)],t=y.useMemo(()=>{if(!r){const a=E(e,n);return{snapshot:a,promise:Promise.resolve(a)}}return r.forEntity(typeof e=="string"||"metadata"in e?e:w(e),n)},s);return N(t.snapshot,t.update$,[t])}const J=k(e=>({root:{display:"inline-flex",alignItems:"center",textDecoration:"inherit"},icon:{marginRight:e.spacing(.5),color:e.palette.text.secondary,"& svg":{verticalAlign:"middle"}}}),{name:"CatalogReactEntityDisplayName"}),S=e=>{const{entityRef:n,hideIcon:i,disableTooltip:r,defaultKind:s,defaultNamespace:t}=e,a=J(),{primaryTitle:d,secondaryTitle:p,Icon:l}=I(n,{defaultKind:s,defaultNamespace:t});let o=u.createElement(u.Fragment,null,d);return o=u.createElement(b,{component:"span",className:a.root},l&&!i?u.createElement(b,{component:"span",className:a.icon},u.createElement(l,{fontSize:"inherit"})):null,o),p&&!r&&(o=u.createElement(T,{enterDelay:1500,title:p},o)),o};S.__docgenInfo={description:`Shows a nice representation of a reference to an entity.
