import{R as r}from"./index-CTjT7uj6.js";import{G as p}from"./Gauge-Dpdho-CD.js";import{m as v}from"./makeStyles-Dm18XSEu.js";import{B as y}from"./Box-ByXAoPiX.js";import{I as b}from"./InfoCard-DsZp0N9S.js";const q=v({root:{height:"100%",width:250},rootSmall:{height:"100%",width:160}},{name:"BackstageGaugeCard"});function f(n){const t=q(n),{title:a,subheader:i,progress:u,inverse:s,deepLink:o,description:g,icon:l,variant:d,alignGauge:m="normal",size:e="normal",getColor:c}=n,k={inverse:s,description:g,getColor:c,value:u};return r.createElement(y,{className:e==="small"?t.rootSmall:t.root},r.createElement(b,{title:a,subheader:i,deepLink:o,variant:d,alignContent:m,icon:l,titleTypographyProps:{...e==="small"?{variant:"subtitle2"}:void 0},subheaderTypographyProps:{...e==="small"?{variant:"body2"}:void 0}},r.createElement(p,{...k,size:e})))}f.__docgenInfo={description:`{@link Gauge} with header, subheader and footer
