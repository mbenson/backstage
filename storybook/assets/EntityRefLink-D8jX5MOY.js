import{r as u,R as o}from"./index-CTjT7uj6.js";import{e as m}from"./routes-DoG4x6fZ.js";import{L as y}from"./Link-V5mBMZDY.js";import{u as f}from"./useRouteRef-ahYS9ypG.js";import{E as g}from"./EntityDisplayName-BTpu6zve.js";import{p as b,D as w}from"./ref-8pKZtiZi.js";const v=u.forwardRef((e,r)=>{const{entityRef:t,defaultKind:n,defaultNamespace:i,title:s,children:a,hideIcon:l,disableTooltip:d,...h}=e,c=k(e.entityRef),p=a??s??o.createElement(g,{entityRef:t,defaultKind:n,defaultNamespace:i,hideIcon:l,disableTooltip:d});return o.createElement(y,{...h,ref:r,to:c},p)});function k(e){const r=f(m);let t,n,i;if(typeof e=="string"){const a=b(e);t=a.kind,n=a.namespace,i=a.name}else"metadata"in e?(t=e.kind,n=e.metadata.namespace,i=e.metadata.name):(t=e.kind,n=e.namespace,i=e.name);t=t.toLocaleLowerCase("en-US"),n=(n==null?void 0:n.toLocaleLowerCase("en-US"))??w;const s={kind:encodeURIComponent(t),namespace:encodeURIComponent(n),name:encodeURIComponent(i)};return r(s)}v.__docgenInfo={description:`Shows a clickable link to an entity.
...
various ways.`},{key:"links",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  namespace: string;
  name: string;
}`,signature:{properties:[{key:"kind",value:{name:"string",required:!0}},{key:"namespace",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}}]}},{name:"string"}]},description:""},defaultKind:{required:!1,tsType:{name:"string"},description:""},defaultNamespace:{required:!1,tsType:{name:"string"},description:""},title:{required:!1,tsType:{name:"string"},description:"@deprecated This option should no longer be used; presentation is requested through the {@link entityPresentationApiRef} instead"},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},hideIcon:{required:!1,tsType:{name:"boolean"},description:""},disableTooltip:{required:!1,tsType:{name:"boolean"},description:""}}};export{v as E};
